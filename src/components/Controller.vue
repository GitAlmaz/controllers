...
<script>
/** 
 * Надеюсь можно использовать намбер инпут
 * при нажатии на "константа" я так понял в первый контролл нужно вписывать 1000
 * при нажатии на "сумма" в первый контрол вписывать значение суммы из 2-го и 3-го
 * за чрезмерное использование рефов извиняюсь, знаю, что не бест практис :с
 * */ 
export default {
  props: {
    changeHandler: {
